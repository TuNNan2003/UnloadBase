...
RC MvccTrxKit::init()
{
  fields_ = vector<FieldMeta>{
    FieldMeta("__trx_xid_begin", AttrType::INTS, 0/*attr_offset*/, 4/*attr_len*/, false/*visible*/,false/*not null*/),
    FieldMeta("__trx_xid_end",   AttrType::INTS, 0/*attr_offset*/, 4/*attr_len*/, false/*visible*/,false/*not null*/)
  };
...
RC MvccTrx::update_record(Table* table, RowTuple* row_tuple, Value value, int index)
{
  return RC::SUCCESS;
}
